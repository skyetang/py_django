    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(verbose_name='评论内容')),
                ('score', models.FloatField(default=5, verbose_name='评分')),
                ('order_comment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='trip.order')),
                ('sight_comment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='trip.sight')),
            ],
        ),
    ]
